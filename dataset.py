...
class FullDataset(Dataset):
    def __init__(self, image_root, gt_root, size, mode):
        with open(image_root, 'r') as yaml_file:
            self.images = yaml.load(yaml_file, Loader=yaml.FullLoader)
        with open(gt_root, 'r') as yaml_file:
            self.gts = yaml.load(yaml_file, Loader=yaml.FullLoader)
